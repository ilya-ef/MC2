...
$$A e^{at} = e^{\ln(A)} e^{at} = e^{a t + \ln(A)} = e^{a\left(\strut t + \ln(A)/a\right)} = e^{a(t-t_0)}\ ,$$
where $$t_0 = - \ln(A)/a = - \ln(573)/0.19 = -33.4\ .$$
